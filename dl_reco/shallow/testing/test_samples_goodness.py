...
parser.add_argument("--number_of_events", type=int, default=10000, help="Name a new Run to be saved")
parser.add_argument("--number_of_samples", type=int, default=1000, help="Name a new Run to be saved")
...
def goodness_with_showers(data, profile_ids, energy, xx, yy, zz, zenith, azimuth):
    ...
    print('goodness_of_fit_final', goodness_of_fit_final)
...
def main_multiprocessing():
    ...
    num_cpus = 100  # You can change this number or use os.cpu_count() for all available CPUs

...
if nccc:
    ...
    data_location_training = '~/data/gen2_deep_snr/nc_cc/training'
    data_location_validating = '~/data/gen2_deep_snr/nc_cc/validating'
    data_location_testing = '~/data/gen2_deep_snr/nc_cc/testing'
...
data_name = 'deep_snr_'     #deep_baseline_10k_00000X.npy
label_name = 'deep_snr_times_'

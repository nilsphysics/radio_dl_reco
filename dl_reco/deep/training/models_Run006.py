...
class Split(pl.LightningModule):
    ...
    def __init__(self, loss_function = 'bce_ggt_15f_split'):
        ...
        self.resnet34_5 = ResNet(ResidualBlock, [3, 4, 6, 3], self.num_classes)
        ...
        self.model1D = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=32, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(32),
            #nn.BatchNorm1d(32),
            nn.ReLU(),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(32),
            ...
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(64),
            nn.ReLU(),
            ...
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(128),
            ...
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(1, 16), padding='same'),
            #nn.BatchNorm2d(256),
            nn.ReLU(),
    ...
    def setup(self, stage=None):
        ...
        seed = hyperparameters.seed  # Choose any integer for your seed
        ...
        # If you're using CUDA (GPU), set the seed for the GPU as well
        #torch.cuda.manual_seed(seed)
        #torch.cuda.manual_seed_all(seed)  # For all GPUs

        # Set deterministic behavior to ensure consistent results on all devices
        #torch.backends.cudnn.deterministic = True
        #torch.backends.cudnn.benchmark = False  # Disable auto-tuning for performance to ensure consistency
    """
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes = 1000):
        ...
        self.conv1 = nn.Sequential(
                        nn.Conv2d(hyperparameters.number_of_antennas, 64, kernel_size = 7, stride = 2, padding = 3),
                        nn.BatchNorm2d(64),
                        nn.ReLU())

...
class southpole_2015_up(medium_base.IceModelSimple):
    def __init__(self):
        ...
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 1.1, 
            delta_n = 0.423 * 1.1,
            )

class southpole_2015_5up(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 1.05, 
            delta_n = 0.423 * 1.05,
            )

class southpole_2015_3up(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 1.03, 
            delta_n = 0.423 * 1.03,
            )

class southpole_2015_1up(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 1.01, 
            delta_n = 0.423 * 1.01,
            )
...
class southpole_2015_down(medium_base.IceModelSimple):
    def __init__(self):
        ...
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 0.9, 
            delta_n = 0.423 * 0.9,
            )

class southpole_2015_5down(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 0.95, 
            delta_n = 0.423 * 0.95,
            )



class southpole_2015_1down(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 0.99, 
            delta_n = 0.423 * 0.99,
            )

class southpole_2015_3down(medium_base.IceModelSimple):
    def __init__(self):
        # from https://doi.org/10.1088/1475-7516/2018/07/055 SPICE2015/SP model
        super().__init__(
            z_bottom = -2820*units.meter, 
            n_ice = 1.78, 
            z_0 = 77.*units.meter * 0.97, 
            delta_n = 0.423 * 0.97,
            )
